  ...
  if (error || !patient) {
    return (
      <div className="space-y-6">
        <Breadcrumbs items={[{ label: 'Patients', href: '/en/patients' }, { label: 'Patient Details' }]} />
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            onClick={() => router.push(`/en/patients/${patient.id}/edit`)}
          >
            <Edit className="h-4 w-4 mr-2" />
            Edit
          </Button>
          <Button onClick={() => router.push(`/en/patients/${patient.id}/visits/new`)}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="visits" className="mt-6">
          <EmptyState
            ...
            onAction={() => router.push(`/en/patients/${patient.id}/visits/new`)}
          />
        </TabsContent>
